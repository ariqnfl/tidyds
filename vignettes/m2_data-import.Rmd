...
ncol(udara_bandung)
dim(udara_bandung)
summary(udara_bandung)
head(udara_bandung,10)
```
...
roster$subject <- ifelse(is.na(roster$subject),"Soccer",roster$subject)
roster
```
